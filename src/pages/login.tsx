...
import { setAccount, updateAccessToken } from '../redux/slices/userSlice';
    ...
    <div className="login-wrap">
      <div className="login-card">
        <aside className="login-card__info" aria-hidden="true">
          <div className="brand">
            <h3 className="brand__title">Smart Parking</h3>
          </div>

          <div className="intro">
            <h4>Chào mừng trở lại!</h4>
            <p>
              Khám phá những dịch vụ đỗ xe thông minh nhất với giá tốt nhất.
              Hệ thống quản lý bãi đỗ xe hiện đại, bảo đảm an toàn.
            </p>
          </div>

          <ul className="benefits">
            <li><span className="check"><IoMdCheckboxOutline style={{ fontSize: "1.2rem"}} /></span> Dịch vụ đỗ xe thông minh</li>
            <li><span className="check"><IoMdCheckboxOutline style={{ fontSize: "1.2rem"}} /></span> Hệ thống quản lý hiện đại</li>
            <li><span className="check"><IoMdCheckboxOutline style={{ fontSize: "1.2rem"}} /></span> Bảo đảm an toàn</li>
          </ul>
        </aside>
        ...
        <main className="login-card__form" aria-label="Login form">
          <header className="form-header">
            <h2>Đăng nhập</h2>
            <p className="muted">Đăng nhập để trải nghiệm tốt nhất</p>
          </header>
